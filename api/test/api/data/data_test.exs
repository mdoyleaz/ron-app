defmodule Api.DataTest do
  ...
  describe "quotes" do
    ...
    @valid_attrs %{average: 42, quote: "some quote", wordLength: 42}
    @update_attrs %{average: 43, quote: "some updated quote", wordLength: 43}
    @invalid_attrs %{average: nil, quote: nil, wordLength: nil}
  ...
  describe "quotes" do
    ...
    @valid_attrs %{average: [], quote: "some quote", wordLength: 42}
    @update_attrs %{average: [], quote: "some updated quote", wordLength: 43}
    @invalid_attrs %{average: nil, quote: nil, wordLength: nil}
  ...
  describe "quotes" do
    ...
    @valid_attrs %{average: [], quote: "some quote", sentenceLength: 42}
    @update_attrs %{average: [], quote: "some updated quote", sentenceLength: 43}
    @invalid_attrs %{average: nil, quote: nil, sentenceLength: nil}
    ...
    test "create_quote/1 with valid data creates a quote" do
      ...
      assert quote.average == []
      assert quote.quote == "some quote"
      assert quote.sentenceLength == 42
    end
    ...
    test "update_quote/2 with valid data updates the quote" do
      ...
      assert quote.average == []
      assert quote.quote == "some updated quote"
      assert quote.sentenceLength == 43
    end
  ...
  describe "quotes" do
    ...
    @valid_attrs %{quote: "some quote", rating: [], sentenceLength: 42}
    @update_attrs %{quote: "some updated quote", rating: [], sentenceLength: 43}
